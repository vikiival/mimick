module.exports = class Data1671018784524 {
    name = 'Data1671018784524'

    async up(db) {
        await db.query(`CREATE TABLE "collection_event" ("id" character varying NOT NULL, "block_number" numeric, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "caller" text NOT NULL, "current_owner" text, "interaction" character varying(7) NOT NULL, "meta" text NOT NULL, "collection_id" character varying, CONSTRAINT "PK_5071dfbea812b4caade2ede2139" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "collection_entity" ("id" character varying NOT NULL, "block_number" numeric, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "current_owner" text NOT NULL, "burned" boolean NOT NULL, "issuer" text NOT NULL, "metadata" text, "name" text, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "nft_count" integer NOT NULL, "supply" integer NOT NULL, "meta_id" character varying, CONSTRAINT "PK_5d44e140c4fcb3d961f9e83405f" PRIMARY KEY ("id"))`)
